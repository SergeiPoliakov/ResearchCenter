	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(!resultsArray.isEmpty()) {
				...
				request.setAttribute("noResults", "В таблице отсутствуют данные, либо таблица задана неправильно");
			}
			RequestDispatcher dispatcher = request.getRequestDispatcher("/oracle_table.jsp");
