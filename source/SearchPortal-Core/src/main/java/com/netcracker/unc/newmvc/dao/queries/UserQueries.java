...
public class UserQueries {
	public static final String SP_USERS_ADD_USER = "INSERT INTO SP_users(login, hash_sum, name, account_type, salt, user_id, email) VALUES(?, ?, ?, ?, ?, SP_USER_ID_SEQ.nextval, ?)";
	...
	public static final String SP_USERS_UPDATE_BY_ID = "UPDATE SP_users SET login = ?, hash_sum = ?, name = ?, account_type = ?, salt= ?, email = ? WHERE user_id = ?";
}
