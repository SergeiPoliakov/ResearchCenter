...
public class SQLQuery {
	...
	public static final String get_invoices_count_for_user = "select count(fin_object_type_ID from SP_FIN_OBJECTS where USER_ID = ? and FIN_OBJECT_TYPE_ID= "
			+ invoice_id;
	public static final String get_all_invoices_for_user_by_user_id = "select fin_object_id, OBJECT_NAME from SP_FIN_OBJECTS where  USER_ID= ? and FIN_OBJECT_TYPE_ID="
			+ invoice_id;
	public static final String get_all_invoices_and_balances_for_user = "select o.OBJECT_NAME, p.value from SP_FIN_OBJECTS o, SP_PARAMS p where USER_ID= ? and p.ATTRIBUTE_ID=1 and o.FIN_OBJECT_TYPE_ID="
			+ invoice_id;
	public static final String get_sum_all_balances_for_users_by_user_id = "select SUM(p.VALUE) from SP_FIN_OBJECTS o, SP_PARAMS p where p.FIN_OBJECT_ID=o.FIN_OBJECT_ID and USER_ID=? and p.ATTRIBUTE_ID=1 and o.FIN_OBJECT_TYPE_ID="
			+ invoice_id;
