...
public class SQLQuery {
	...
	public static final String FIN_OBJECT_TYPES_GET_BY_NAME = "SELECT * FROM fin_object_types WHERE fin_object_type_name like ?";
	...
	public static final String FIN_OBJECTS_GET_BY_NAME = "SELECT * FROM fin_objects WHERE object_name = ?";
