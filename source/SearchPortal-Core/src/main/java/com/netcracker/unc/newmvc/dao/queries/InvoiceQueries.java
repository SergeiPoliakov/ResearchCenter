...
public class InvoiceQueries {
	...
	public static final String getInvoice = "select FIN_OBJECT_ID, OBJECT_NAME from SP_FIN_OBJECTS where USER_ID = ? and FIN_OBJECT_ID = ?";
	...
	public static final String getInvoicesCount = "select count(fin_object_type_ID from SP_FIN_OBJECTS where USER_ID = ? and FIN_OBJECT_TYPE_ID= "
			+ invoice_id;
	...
	public static final String getAllInvoicesAndBalances = "select o.OBJECT_NAME, p.value from SP_FIN_OBJECTS o, SP_PARAMS p where USER_ID= ? and p.ATTRIBUTE_ID=1 and o.FIN_OBJECT_TYPE_ID="
			+ invoice_id;
	public static final String getSumAllBalancesByUserId = "select SUM(p.VALUE) from SP_FIN_OBJECTS o, SP_PARAMS p where p.FIN_OBJECT_ID=o.FIN_OBJECT_ID and USER_ID=? and p.ATTRIBUTE_ID=1 and o.FIN_OBJECT_TYPE_ID="
			+ invoice_id;
	...
	public static final String setBalance = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (1,?, ?)";
	public static final String setCredit = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (2, ?, ?)";
	public static final String setPercent = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (3, ?, ?)";

	public static final String updateInvoise = "update SP_FIN_OBJECTS set Object_name = ? where user_id = ?";
	public static final String updateBalance = "UPDATE SP_params SET value = ? WHERE ATTRIBUTE_ID=1 and fin_object_id =?";
	public static final String updateCredit = "UPDATE SP_params SET value = ? WHERE fin_object_id = ? and ATTRIBUTE_ID=2";
	public static final String updatePercent = "UPDATE SP_params SET value = ? WHERE fin_object_id = ? and ATTRIBUTE_ID=3";
