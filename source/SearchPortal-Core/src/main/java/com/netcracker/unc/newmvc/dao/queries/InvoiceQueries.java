...
public class InvoiceQueries {
	...
	public static final String getInvoicesCountForUser = "select count(fin_object_type_ID from SP_FIN_OBJECTS where USER_ID = ? and FIN_OBJECT_TYPE_ID= "
			+ invoice_id;
	public static final String getAllInvoicesForUserByUserId = "select o.FIN_OBJECT_ID, o.OBJECT_NAME, p.value, a.VALUE, r.VALUE\n"
                                                              +"from SP_PARAMS p, SP_PARAMS a, SP_PARAMS r, SP_FIN_OBJECTS o\n"
                                                              +"where p.FIN_OBJECT_ID = o.FIN_OBJECT_ID and  a.FIN_OBJECT_ID = o.FIN_OBJECT_ID and  r.FIN_OBJECT_ID = o.FIN_OBJECT_ID and \n"
                                                              +"o.USER_ID=? and p.ATTRIBUTE_ID=1 and a.ATTRIBUTE_ID=2 and r.ATTRIBUTE_ID=3\n"
	...
	public static final String setNewBalanceInInvoiceByInvoiceId = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (1,?, ?)";
	public static final String setNewCreditInInvoiceByInvoiceId = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (2, ?, ?)";
	public static final String setNewPercentInInvoiceByInvoiceId = "insert into SP_PARAMS(ATTRIBUTE_ID, FIN_OBJECT_ID, VALUE) values (3, ?, ?)";
	...
	public static final String deleteInvoiceNameByInvoiceId = " delete from SP_FIN_OBJECTS where FIN_OBJECT_ID = ?";
	public static final String deleteParamInvoiceByInvoiceId = "delete from SP_PARAMS WHERE FIN_OBJECT_ID = ?";
}
