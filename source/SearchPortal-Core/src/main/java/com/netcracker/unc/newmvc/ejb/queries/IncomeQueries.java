...
public class IncomeQueries {
	...
	public static final String getAllIncomeByUserId = "select distinct o.FIN_OBJECT_ID, o.OBJECT_NAME t, d.VALUE_DATE, s.VALUE a, m.VALUE b, o.PARENT_ID, i.OBJECT_NAME r\n"+
