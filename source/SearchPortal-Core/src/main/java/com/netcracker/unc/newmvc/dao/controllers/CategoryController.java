...
public class CategoryController {
	...
	public List<CategoryModel> getCategories() {
		...
		List<CategoryModel> categoryModels = new ArrayList<CategoryModel>(
				categoryDAO.getAllUserCategories(userModel.getUserId()));
	...
	public List<CategoryModel> getCategoriesWithPriorities() {
		CategoryDAO categoryDAO = new CategoryDAO();
		List<CategoryModel> categoryModels = new ArrayList<CategoryModel>(
				categoryDAO.getAllCategoriesWithSumUser(userModel.getUserId()));
	...
	public List<CategoryModel> getCategoriesWithSum(int userId) {
		CategoryDAO categoryDAO = new CategoryDAO();
		List<CategoryModel> categoryModels = new ArrayList<CategoryModel>(
				categoryDAO.getAllCategoriesWithSumUser(userId));
		if (categoryModels.isEmpty())
			categoryModels = Collections.emptyList();
		return categoryModels;
	}
