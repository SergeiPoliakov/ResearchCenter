...
<body>
	<jsp:include page="/int"></jsp:include>
			<table border="1">
				<thead align="center">
					<tr>
			...
			<button id="statistic-menu-button" class="button"
				onclick="addCredit()">Добавить кредит</button>
			...
			<input type = "hidden" value='addCredit' name="credit">
				<div id="add-credit" style="visibility: hidden;">
						...
						<input type="text" name="credit-name" size="5" placeholder="Название кредита" /> 
						<input type="number" name="credit-value" size="5" placeholder="Сумма" />
						<input type="number" name="credit-balance" size="5" placeholder="Остаток платежа" /> 
						<input type="number" name="credit-percent" size="5" placeholder="Процентная ставка" />
						<input type="number" name="credit-date" size="5" placeholder="Дата получения" />
						<input type="number" name="credit-period" size="5" placeholder="Период платежа(дней)"/> 
